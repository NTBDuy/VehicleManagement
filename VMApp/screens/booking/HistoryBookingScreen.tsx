...
const HistoryBookingScreen = () => {
  ...
  const renderRequestItem = ({ item }: { item: Request }) => (
    <Pressable
      ...
      // className={`mb-4 rounded-2xl border-r-2 border-t-2 bg-gray-100 px-4 py-4 border-gray-600`}
      // className={`mb-4 rounded-2xl border-r-2 border-t-2 bg-gray-100 px-4 py-4 border-red-600`}
      // className={`mb-4 rounded-2xl border-r-2 border-t-2 bg-gray-100 px-4 py-4 border-orange-600`}
